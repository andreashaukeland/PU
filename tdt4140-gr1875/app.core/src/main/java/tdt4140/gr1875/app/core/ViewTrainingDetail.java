...
public class ViewTrainingDetail {
	...
	public String[] getTrainingInformation() {
		...
		int currentRunner = SessionInformation.userType.equals("runner") ? SessionInformation.userId : SessionInformation.currentRunnerViewed;
		ArrayList<ArrayList<String>> training = UseDB.getTable("Select place, time, date, distance from training where trainingid="+currentTraining);
